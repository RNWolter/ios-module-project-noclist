...
let Ethan_Hunt = (coverName: "Ethan Hunt", realName: "Tom Cruise", accessLevel: 8, compromised: false)
let Jim_Phillips = (coverName: "Jim Phelps", realName: "Jon Voight", accessLevel: 9, compromised: true)
let Claire_Phelps = (coverName: "Claire Phelps", realName: "Emmanuelle Beart", accessLevel: 5, compromised: false)
let Eugene_Kittridge = (coverName: "Eugene Kittridge", realName: "Henry Czerny", accessLevel: 10, compromised: true)
let Franz_Krieger = (coverName: "Franz Krieger", realName: "Jean Reno", accessLevel: 4, compromised: false)
let Luther_Stickell = (coverName: "Luther Stickell", realName: "Ving Rhames", accessLevel: 4, compromised: false)
let Sarah_Davies = (coverName: "Sarah Davies", realName: "Kristin Scott Thomas", accessLevel: 5, compromised: true)
let Max_RotGrab = (coverName: "Max RotGrab", realName: "Vanessa Redgrave", accessLevel: 4, compromised: false)
let Hannah_Williams = (coverName: "Hannah Williams", realName: "Ingeborga Dapkūnaitė", accessLevel: 5, compromised: true)
let Jack_Harmon = (coverName: "Jack Harmon", realName: "Emilio Estevez", accessLevel: 6, compromised: true)
let Frank_Barnes = (coverName: "Frank Barnes", realName: "Dale Dye", accessLevel: 9, compromised: false)


//: ## Step 2
//: Place the above constants inside an array. Declare this array as a constant as well.
let agents = [Ethan_Hunt,Jim_Phillips,Claire_Phelps,Eugene_Kittridge,Franz_Krieger,Luther_Stickell,Sarah_Davies,Max_RotGrab,Hannah_Williams,Jack_Harmon,Frank_Barnes]


//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.
func countCompromisedAgents() -> Int {
    var countTheCompromised = 0
    for anAgent in agents{
        if anAgent.compromised {
            print("\(anAgent.realName) has been compromised")
            countTheCompromised += 1
        }
    }
    return countTheCompromised
...
print("\(countCompromisedAgents()) agents have been compromised!")
...
func findCleanAgents() -> [(String,String,Int,Bool)] {
    ...
    var uncompromisedAgents = [(String,String,Int,Bool)]()
    
    for anAgent in agents {
        if !(anAgent.compromised){
            print(anAgent.coverName)
            uncompromisedAgents.append(anAgent)
        }
    }
...
print("\(findCleanAgents().count) clean agents out of \(agents.count)")
    ...
    for agent in agents{
        ...
        case 8...10:
            if (agent.compromised) {
                print("Agent:\(agent.realName)   access level: \(agent.accessLevel) **Warning**  **Compromised**")
            } else {
                 print("Agent:\(agent.realName)   access level: \(agent.accessLevel)")
            }
        default:
                    continue
        }
